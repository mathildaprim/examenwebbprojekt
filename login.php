...
//1 = admin, 2 = användareadmin, 3 = användaren

if(isset($_POST['email'])) //Logga in med email. 
{
...
$res = $mysqli->query($query); //Hämtar uppgifter hos sessions-användaren.
if ($res->num_rows > 0)
{
...
END;
  ...
  {
    echo "Fel email eller lösenord."; //Om fel information skrivs i vid inlogg visas detta felmeddelande.
  }
}
 $content = <<<END
  ...
  <li role="presentation" class="active"><a href="#">Email</a></li>
  <li role="presentation"><a href="loginlicens.php">Licens ID</a></li>
                          </ul>

                <form method="post" action="login.php">
           
                <div class="form-group">
                    <input name="email" type="email" class="form-control" placeholder="Email" maxlength="50" pattern="[A-Za-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Exempel username@gmail.com" required>
                </div>
